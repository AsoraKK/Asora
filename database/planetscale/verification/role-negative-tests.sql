...
SELECT has_database_privilege(current_user, current_database(), 'CREATEROLE') AS must_be_false_for_admin;
...
SELECT has_database_privilege(current_user, current_database(), 'CREATEROLE') AS must_be_false_for_jobs;

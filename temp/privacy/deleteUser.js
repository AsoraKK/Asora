...
const deleteRateLimiter = (0, rate_limiter_1.createRateLimiter)({
    ...
    maxRequests: 1,
    keyGenerator: (0, rate_limiter_1.endpointKeyGenerator)('privacy_delete')
});
async function deleteUser(request, context) {
    ...
    try {
        ...
        const user = (0, auth_utils_1.requireUser)(context, request);
        ...
        if (confirmHeader !== 'true') {
            ...
            return (0, auth_utils_1.json)(400, {
        ...
        if (rateLimitResult.blocked) {
            ...
            return (0, auth_utils_1.json)(429, {
        ...
        context.log(`Account deletion completed successfully for user ${userId}:`, {
            deletionId,
            totalItemsDeleted: Object.values(itemsProcessed).reduce((sum, val) => {
        ...
        return (0, auth_utils_1.json)(200, {
        ...
        if ((0, auth_utils_1.isHttpError)(error)) {
            return (0, auth_utils_1.json)(error.status, error.body);
        }
        // Handle unexpected errors
        context.error('Critical error during account deletion:', error);
        return (0, auth_utils_1.json)(500, {
            code: 'server_error',

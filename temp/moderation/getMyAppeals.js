...
exports.getMyAppeals = getMyAppeals;
const cosmos_1 = require("@azure/cosmos");
const auth_utils_1 = require("../shared/auth-utils");
async function getMyAppeals(request, context) {
    ...
    try {
        ...
        const formattedAppeals = appeals.map(appeal => {
            ...
            if (appeal.expiresAt)
                appealSummary.expiresAt = appeal.expiresAt;
            if (appeal.resolvedAt)
                appealSummary.resolvedAt = appeal.resolvedAt;
            if (appeal.finalDecision)
                appealSummary.finalDecision = appeal.finalDecision;
...
//# sourceMappingURL=getMyAppeals.js.map
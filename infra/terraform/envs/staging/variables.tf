variable "account_name" {
  description = "Cosmos account name for staging"
  type        = string
}
...
variable "observability_alert_email_addresses" {
  ...
  validation {
    ...
    error_message = "When observability is enabled, at least one alert recipient email is required."
  }
}
...
variable "function_app_name" {
  description = "Function App name used to derive monitored resource ID when function_app_resource_id is empty"
  type        = string
  default     = "asora-function-staging"

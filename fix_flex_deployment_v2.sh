...
az rest --method PATCH --uri "$SITE_URI" --body "$JSON_BODY"
echo "functionAppConfig updated"

echo "=== Restarting and verifying ==="
# === 4) Restart and verify ===
az functionapp restart -g "$RG" -n "$APP"
echo "App restarted, waiting 25 seconds..."
sleep 25
echo "Testing health endpoint:"
curl -i "https://$APP.azurewebsites.net/api/health" | head -5

...
var exportRateLimiter = (0, rate_limiter_1.createRateLimiter)({
...
function exportUser(request, context) {
    return __awaiter(this, void 0, void 0, function () {
        var exportId, authHeader, token, jwtPayload, userId, rateLimitResult, cosmosClient, database, usersContainer, postsContainer, commentsContainer, flagsContainer, appealsContainer, votesContainer, likesContainer, userProfile, accountCreationDate, user, error_1, userPosts_1, postsQuery, posts, error_2, userComments_1, commentsQuery, comments, error_3, userLikes_1, likesQuery, likes, error_4, userFlags_1, flagsQuery, flags, error_5, userAppeals_1, appealsQuery, appeals, error_6, userVotes_1, votesQuery, votes, error_7, previousExports, dataRequests, exportData, error_8;
            ...
            switch (_a.label) {
                ...
                case 5:
                    ...
                    if (user) {
                        ...
                        context.log("Warning: User profile not found for ".concat(userId, ", using minimal data"));
                        userProfile = {
                            id: userId,
                            displayName: 'User',

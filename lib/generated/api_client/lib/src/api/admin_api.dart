...
import 'package:lythaus_api_client/src/model/admin_appeal_decision_response.dart';
import 'package:lythaus_api_client/src/model/admin_appeal_detail_response.dart';
import 'package:lythaus_api_client/src/model/admin_appeal_override_request.dart';
import 'package:lythaus_api_client/src/model/admin_appeal_override_response.dart';
import 'package:lythaus_api_client/src/model/admin_appeal_queue_response.dart';
import 'package:lythaus_api_client/src/model/admin_audit_list_response.dart';
import 'package:lythaus_api_client/src/model/admin_content_action_request.dart';
import 'package:lythaus_api_client/src/model/admin_content_action_response.dart';
import 'package:lythaus_api_client/src/model/admin_created_invite.dart';
import 'package:lythaus_api_client/src/model/admin_flag_detail_response.dart';
import 'package:lythaus_api_client/src/model/admin_flag_queue_response.dart';
import 'package:lythaus_api_client/src/model/admin_flag_resolve_request.dart';
import 'package:lythaus_api_client/src/model/admin_invite_batch_request.dart';
import 'package:lythaus_api_client/src/model/admin_invite_batch_response.dart';
import 'package:lythaus_api_client/src/model/admin_invite_create_request.dart';
import 'package:lythaus_api_client/src/model/admin_invite_list_response.dart';
import 'package:lythaus_api_client/src/model/admin_invite_response.dart';
import 'package:lythaus_api_client/src/model/admin_invite_revoke_request.dart';
import 'package:lythaus_api_client/src/model/admin_invite_revoke_response.dart';
import 'package:lythaus_api_client/src/model/admin_resolve_response.dart';
import 'package:lythaus_api_client/src/model/admin_set_user_tier_request.dart';
import 'package:lythaus_api_client/src/model/admin_test_data_purge200_response.dart';
import 'package:lythaus_api_client/src/model/admin_test_data_purge_request.dart';
import 'package:lythaus_api_client/src/model/admin_user_action_response.dart';
import 'package:lythaus_api_client/src/model/admin_user_disable_request.dart';
import 'package:lythaus_api_client/src/model/admin_user_enable_request.dart';
import 'package:lythaus_api_client/src/model/admin_user_search_response.dart';
...
class AdminApi {
  ...
  Future<Response<AdminAppealDecisionResponse>> adminAppealsApprove({
    ...
    AdminAppealDecisionResponse? _responseData;
    ...
    return Response<AdminAppealDecisionResponse>(
      data: _responseData,
  ...
  Future<Response<AdminAppealDetailResponse>> adminAppealsGet({
    ...
    AdminAppealDetailResponse? _responseData;
    ...
    return Response<AdminAppealDetailResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<AdminAppealQueueResponse>> adminAppealsList({
    ...
    AdminAppealQueueResponse? _responseData;
    ...
    return Response<AdminAppealQueueResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<AdminAppealOverrideResponse>> adminAppealsOverride({
    ...
    AdminAppealOverrideResponse? _responseData;
    ...
    return Response<AdminAppealOverrideResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<AdminAuditListResponse>> adminAuditList({
    ...
    AdminAuditListResponse? _responseData;
    ...
    return Response<AdminAuditListResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<AdminContentActionResponse>> adminContentBlock({
    ...
    AdminContentActionResponse? _responseData;
    ...
    return Response<AdminContentActionResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<JsonObject>> adminDsrLegalHoldPlace({
    ...
    final _path = r'/_admin/dsr/legal-holds';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<AdminFlagDetailResponse>> adminFlagsGet({
    ...
    AdminFlagDetailResponse? _responseData;
    ...
    return Response<AdminFlagDetailResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<AdminFlagQueueResponse>> adminFlagsList({
    ...
    AdminFlagQueueResponse? _responseData;
    ...
    return Response<AdminFlagQueueResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<AdminResolveResponse>> adminFlagsResolve({
    ...
    AdminResolveResponse? _responseData;
    ...
    return Response<AdminResolveResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<AdminInviteBatchResponse>> adminInvitesBatch({
    ...
    final _path = r'/_admin/invites/batch';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    AdminInviteBatchResponse? _responseData;
    ...
    return Response<AdminInviteBatchResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [AdminCreatedInvite] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AdminCreatedInvite>> adminInvitesCreate({
    ...
    AdminCreatedInvite? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(AdminCreatedInvite),
      ) as AdminCreatedInvite;
    ...
    return Response<AdminCreatedInvite>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  ///
  /// Parameters:
  /// * [inviteId] - Opaque invite identifier
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AdminInviteRevokeResponse>> adminInvitesDelete({
    ...
    final _path = r'/_admin/invites/{inviteId}'.replaceAll('{' r'inviteId' '}', encodeQueryParameter(_serializers, inviteId, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
    ...
    AdminInviteRevokeResponse? _responseData;
    ...
    return Response<AdminInviteRevokeResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<AdminInviteResponse>> adminInvitesGet({
    ...
    AdminInviteResponse? _responseData;
    ...
    return Response<AdminInviteResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [unused] - Filter for unused invites only
  /// * [cursor] - Cursor for pagination
  ...
  Future<Response<AdminInviteListResponse>> adminInvitesList({
    ...
    AdminInviteListResponse? _responseData;
    ...
    return Response<AdminInviteListResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<AdminInviteRevokeResponse>> adminInvitesRevoke({
    ...
    final _path = r'/_admin/invites/{inviteId}/revoke'.replaceAll('{' r'inviteId' '}', encodeQueryParameter(_serializers, inviteId, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<JsonObject>> adminModerationClassesList({
    ...
    final _path = r'/admin/moderation-classes';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<JsonObject>> adminModerationWeightsUpdate({
    ...
    final _path = r'/admin/moderation-classes/weights';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<JsonObject>> adminNewsIngest({
    ...
    final _path = r'/_admin/news/ingest';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<JsonObject>> adminOpsMetrics({
    ...
    final _path = r'/_admin/ops/metrics';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<JsonObject>> adminOpsStateGet({
    ...
    final _path = r'/_admin/ops/state';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<AdminTestDataPurge200Response>> adminTestDataPurge({
    ...
    final _path = r'/admin/test-data/purge';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(AdminTestDataPurgeRequest);
      _bodyData = _serializers.serialize(adminTestDataPurgeRequest, specifiedType: _type);
    ...
    AdminTestDataPurge200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(AdminTestDataPurge200Response),
      ) as AdminTestDataPurge200Response;
    ...
    return Response<AdminTestDataPurge200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<AdminUserSearchResponse>> adminUsersSearch({
    ...
    final _path = r'/_admin/users/search';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    AdminUserSearchResponse? _responseData;
    ...
    return Response<AdminUserSearchResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,

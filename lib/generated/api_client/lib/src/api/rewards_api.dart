...
class RewardsApi {
  ...
  Future<Response<RewardsMeResponse>> rewardsMeGet({
    ...
    RewardsMeResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(RewardsMeResponse),
      ) as RewardsMeResponse;
    ...
    return Response<RewardsMeResponse>(
      data: _responseData,
  ...
  Future<Response<RewardRedemption>> rewardsRedeemPost({
    ...
    final _path = r'/rewards/{id}/redeem'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    RewardRedemption? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(RewardRedemption),
      ) as RewardRedemption;
    ...
    return Response<RewardRedemption>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,

...
class ReputationApi {
  ...
  Future<Response<LedgerPage>> reputationLedgerGet({ 
    ...
    final _path = r'/reputation/me/ledger';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<PublicReputationView>> reputationUserGet({ 
    ...
    final _path = r'/reputation/users/{id}'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<PublicReputationView>> reputationUserGetSingular({ 
    ...
    final _path = r'/reputation/user/{id}'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,

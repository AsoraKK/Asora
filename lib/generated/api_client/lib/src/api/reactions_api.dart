...
class ReactionsApi {
  ...
  Future<Response<void>> reactionsDelete({ 
    ...
    final _path = r'/reactions/{id}'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
  ...
  Future<Response<SubmitReactionResponse>> reactionsPost({ 
    ...
    try {
      const _type = FullType(SubmitReactionRequest);
      _bodyData = _serializers.serialize(submitReactionRequest, specifiedType: _type);
    ...
    SubmitReactionResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(SubmitReactionResponse),
      ) as SubmitReactionResponse;
    ...
    return Response<SubmitReactionResponse>(
      data: _responseData,

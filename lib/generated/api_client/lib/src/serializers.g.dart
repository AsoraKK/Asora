    ...
    (Serializers().toBuilder()
          ...
          ..addBuilderFactory(
            const FullType(BuiltList, const [
              const FullType(AdminAppealQueueItem),
            ]),
            () => ListBuilder<AdminAppealQueueItem>(),
          )
          ..addBuilderFactory(
            const FullType(BuiltList, const [
              const FullType(AdminFlagDetailReason),
            ]),
            () => ListBuilder<AdminFlagDetailReason>(),
          )
          ..addBuilderFactory(
            const FullType(BuiltList, const [
              const FullType(AdminFlagHistoryFlag),
            ]),
            () => ListBuilder<AdminFlagHistoryFlag>(),
          )
          ..addBuilderFactory(
            const FullType(BuiltList, const [
              const FullType(AdminFlagHistoryAdminAction),
            ]),
            () => ListBuilder<AdminFlagHistoryAdminAction>(),
          )
          ..addBuilderFactory(
            const FullType(BuiltList, const [
              const FullType(AdminFlagQueueItem),
            ]),

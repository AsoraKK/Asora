/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=apps/lythaus-public-api/wrangler.jsonc --env=development apps/lythaus-public-api/src/worker-configuration.d.ts` (hash: 506f5387a6b7c41d1758441357140bc2)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "EXPECTED_HOSTNAMES" | "R2_ACCOUNT_ID" | "MEDIA_QUOTA_BYTES" | "EMAIL_PROVIDER_URL" | "EMAIL_FROM" | "CORS_ALLOWED_ORIGINS" | "HYPERDRIVE_QUERY_CACHE_MODE">> {}
}

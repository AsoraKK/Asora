/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=apps/lythaus-public-api/wrangler.jsonc --env=development apps/lythaus-public-api/src/worker-configuration.d.ts` (hash: 9c64103e8124e9cc364559544a6fca3a)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "EXPECTED_HOSTNAMES" | "R2_ACCOUNT_ID" | "MEDIA_QUOTA_BYTES" | "EMAIL_PROVIDER_URL" | "EMAIL_FROM" | "GOOGLE_CLIENT_ID" | "GOOGLE_REDIRECT_URI" | "GOOGLE_JWKS_URL" | "CORS_ALLOWED_ORIGINS" | "HYPERDRIVE_QUERY_CACHE_MODE">> {}
}

/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=apps/lythaus-public-api/wrangler.jsonc --env=development apps/lythaus-public-api/src/worker-configuration.d.ts` (hash: 542ab8b66da2584b5889b52acebc21d2)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "EXPECTED_HOSTNAMES" | "R2_ACCOUNT_ID" | "MEDIA_QUOTA_BYTES" | "EMAIL_PROVIDER_URL" | "EMAIL_FROM" | "EMAIL_VERIFICATION_BASE_URL" | "GOOGLE_CLIENT_ID" | "GOOGLE_REDIRECT_URI" | "GOOGLE_JWKS_URL" | "CORS_ALLOWED_ORIGINS" | "HYPERDRIVE_QUERY_CACHE_MODE">> {}
}

/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc --env=development src/worker-configuration.d.ts` (hash: 8eadf17c6a43b6eab0b5967ff3175f4c)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "EXPECTED_HOSTNAMES" | "R2_ACCOUNT_ID" | "CORS_ALLOWED_ORIGINS" | "HYPERDRIVE_QUERY_CACHE_MODE">> {}
}

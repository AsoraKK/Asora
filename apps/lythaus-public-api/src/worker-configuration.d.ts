/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=apps/lythaus-public-api/wrangler.jsonc --env=development apps/lythaus-public-api/src/worker-configuration.d.ts` (hash: 1ca7f229563531f55ce054ddce22eabd)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "EXPECTED_HOSTNAMES" | "R2_ACCOUNT_ID" | "MEDIA_QUOTA_BYTES" | "MEDIA_QUARANTINE_BUCKET" | "MEDIA_APPROVED_BUCKET" | "EMAIL_PROVIDER_URL" | "EMAIL_FROM" | "EMAIL_VERIFICATION_BASE_URL" | "EMAIL_PASSWORD_RESET_BASE_URL" | "GOOGLE_CLIENT_ID" | "GOOGLE_REDIRECT_URI" | "GOOGLE_JWKS_URL" | "TURNSTILE_REQUIRED" | "CORS_ALLOWED_ORIGINS" | "HYPERDRIVE_QUERY_CACHE_MODE">> {}
}

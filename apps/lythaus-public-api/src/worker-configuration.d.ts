/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=apps/lythaus-public-api/wrangler.jsonc apps/lythaus-public-api/src/worker-configuration.d.ts` (hash: 627449903ca1d82d9b7a43eb993b8aaa)
// Runtime types generated with workerd@1.20260722.1 2026-07-27 nodejs_compat
interface __BaseEnv_Env {
	LYTHAUS_CONFIG: KVNamespace;
	MEDIA_QUARANTINE: R2Bucket;
	MEDIA_APPROVED: R2Bucket;
	DB_APP_FRESH: Hyperdrive;
	...
	MEDIA_APPROVED_BUCKET: "lythaus-media-approved-dev";
	MEDIA_UPLOADS_ENABLED: "false";
	EMAIL_PROVIDER_URL: "http://localhost:8788/email" | "";
	EMAIL_PROVIDER_MODE: "fallback" | "disabled";
	...
	GOOGLE_REDIRECT_URI: "http://localhost:8787/api/auth/google/callback" | "https://api.lythaus.co/api/auth/google/callback";
	GOOGLE_JWKS_URL: "https://www.googleapis.com/oauth2/v3/certs";
	TURNSTILE_REQUIRED: "false";
	PASSWORD_HASH_ALLOW_SCRYPT_FALLBACK: "true" | "false";
	CORS_ALLOWED_ORIGINS: "http://localhost:3000" | "https://app.lythaus.co";
	HYPERDRIVE_QUERY_CACHE_MODE: "disabled";
	EXPECTED_DATABASE_TARGET: "development" | "main";
	EXPECTED_DATABASE_SCHEMA_FINGERPRINT: "8922ea383a1a9ff32b9b695e3b04bf5f56648d6a7371d8a35b49db7fae394ad8" | "86ff272e09dbd195f18d262c354449ececdb907663615786c90a0d630b8f8625";
	EXPECTED_DATABASE_RELATION_COUNT: "77" | "78";
	EXPECTED_DATABASE_SCHEMA_VERSION: "unknown" | "0008_legacy_relink_status.sql";
	EXPECTED_DATABASE_ROLE_CLASS: "login_non_superuser";
	EXPECTED_DATABASE_BUDGET_LEDGER_APPLIED?: "false";
...
declare namespace Cloudflare {
	...
	interface DevelopmentEnv {
		...
		HYPERDRIVE_QUERY_CACHE_MODE: "disabled";
		EXPECTED_DATABASE_TARGET: "development";
		EXPECTED_DATABASE_SCHEMA_FINGERPRINT: "8922ea383a1a9ff32b9b695e3b04bf5f56648d6a7371d8a35b49db7fae394ad8";
		EXPECTED_DATABASE_RELATION_COUNT: "77";
		EXPECTED_DATABASE_SCHEMA_VERSION: "unknown";
		EXPECTED_DATABASE_ROLE_CLASS: "login_non_superuser";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "EXPECTED_HOSTNAMES" | "R2_ACCOUNT_ID" | "MEDIA_QUOTA_BYTES" | "MEDIA_QUARANTINE_BUCKET" | "MEDIA_APPROVED_BUCKET" | "MEDIA_UPLOADS_ENABLED" | "EMAIL_PROVIDER_URL" | "EMAIL_PROVIDER_MODE" | "EMAIL_FROM" | "EMAIL_VERIFICATION_BASE_URL" | "EMAIL_PASSWORD_RESET_BASE_URL" | "GOOGLE_CLIENT_ID" | "GOOGLE_REDIRECT_URI" | "GOOGLE_JWKS_URL" | "TURNSTILE_REQUIRED" | "PASSWORD_HASH_ALLOW_SCRYPT_FALLBACK" | "CORS_ALLOWED_ORIGINS" | "HYPERDRIVE_QUERY_CACHE_MODE" | "EXPECTED_DATABASE_TARGET" | "EXPECTED_DATABASE_SCHEMA_FINGERPRINT" | "EXPECTED_DATABASE_RELATION_COUNT" | "EXPECTED_DATABASE_SCHEMA_VERSION" | "EXPECTED_DATABASE_ROLE_CLASS" | "EXPECTED_DATABASE_BUDGET_LEDGER_APPLIED" | "AUTHENTICATED_ACCEPTANCE_PROVEN">> {}
}

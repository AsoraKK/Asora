/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=apps/lythaus-admin-api/wrangler.jsonc --env=development apps/lythaus-admin-api/src/worker-configuration.d.ts` (hash: a1f52cb6dded43a79631b4312654e8d1)
...
interface __BaseEnv_Env {
	...
	ACCESS_AUDIENCE: "REPLACE_WITH_ACCESS_AUDIENCE";
	ACCESS_JWKS_URL: "REPLACE_WITH_ACCESS_JWKS_URL";
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "EXPECTED_HOSTNAMES" | "CORS_ALLOWED_ORIGINS" | "HYPERDRIVE_QUERY_CACHE_MODE" | "ACCESS_TEAM_DOMAIN" | "ACCESS_AUDIENCE" | "ACCESS_JWKS_URL">> {}
}

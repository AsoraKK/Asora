/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc --env=development src/worker-configuration.d.ts` (hash: a1f52cb6dded43a79631b4312654e8d1)

/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=apps/lythaus-jobs/wrangler.jsonc apps/lythaus-jobs/src/worker-configuration.d.ts` (hash: f5be8338ac51003e9ddda107946d3bc9)
...
interface __BaseEnv_Env {
	...
	PAID_AI_DETECTION_ENABLED: "false";
	HIVE_API_URL: "";
	HIVE_MODEL_VERSION: "";
	...
	EXTERNAL_BACKUP_HEALTHCHECK_URL: "";
	ACCOUNT_DELETE: Workflow<Parameters<import("./index").AccountDeleteWorkflow['run']>[0]['payload']>;
	ACCOUNT_EXPORT: Workflow<Parameters<import("./index").AccountExportWorkflow['run']>[0]['payload']>;
	RETENTION_CLEANUP: Workflow<Parameters<import("./index").RetentionCleanupWorkflow['run']>[0]['payload']>;
	APPEAL_LIFECYCLE: Workflow<Parameters<import("./index").AppealLifecycleWorkflow['run']>[0]['payload']>;
	BACKUP_VALIDATION: Workflow<Parameters<import("./index").BackupValidationWorkflow['run']>[0]['payload']>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "HYPERDRIVE_QUERY_CACHE_MODE" | "PAID_AI_DETECTION_ENABLED" | "HIVE_API_URL" | "HIVE_MODEL_VERSION" | "R2_ACCOUNT_ID" | "MEDIA_PROCESSING_ENABLED" | "MEDIA_QUARANTINE_BUCKET" | "MEDIA_APPROVED_BUCKET" | "EXTERNAL_BACKUP_HEALTHCHECK_URL">> {}
}

/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=apps/lythaus-jobs/wrangler.jsonc --env=development apps/lythaus-jobs/src/worker-configuration.d.ts` (hash: fb926930c98730228bc9977839df5a01)

/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc --env=development src/worker-configuration.d.ts` (hash: 01c98b380433b647e6aa036371bf0a9f)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "HYPERDRIVE_QUERY_CACHE_MODE">> {}
}

/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=apps/lythaus-jobs/wrangler.jsonc --env=development apps/lythaus-jobs/src/worker-configuration.d.ts` (hash: 83efe978da8ec751273c148e23300407)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "HYPERDRIVE_QUERY_CACHE_MODE" | "HIVE_API_URL" | "HIVE_MODEL_VERSION" | "R2_ACCOUNT_ID">> {}
}

/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=apps/lythaus-jobs/wrangler.jsonc --env=development apps/lythaus-jobs/src/worker-configuration.d.ts` (hash: fd2f02fdd52fd519bb77ebe1c690be37)
...
interface __BaseEnv_Env {
	...
	HIVE_MODEL_VERSION: "general_text_classification+hate_speech_detection_text+violence_text_detection";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "HYPERDRIVE_QUERY_CACHE_MODE" | "HIVE_API_URL" | "HIVE_MODEL_VERSION" | "R2_ACCOUNT_ID" | "MEDIA_QUARANTINE_BUCKET" | "MEDIA_APPROVED_BUCKET">> {}
}

...
**Consequences:**
- Deep-linkable user profiles: `https://app.lythaus.co/user/abc123` shows that user's profile. An immutable Pages preview may be used for validation but is never canonical.

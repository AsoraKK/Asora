...
| --- | --- | --- | --- |
| `GET /api/auth/authorize` | n/a | `20 / 60s` | 30-minute auth-failure backoff |
...
| `POST /api/moderation/appeals/{appealId}/vote` and `POST /api/appeals/{id}/votes` | `20 / 60s`, burst `5` | `25 / 60s` | appeal voting |

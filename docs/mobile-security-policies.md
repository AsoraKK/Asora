...
Lythaus (formerly ASORA) implements risk-based security policies for device integrity checks, varying by environment and use case. This document defines policy matrices and decision logic for compromised devices.
